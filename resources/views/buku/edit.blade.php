        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800">
                    <h1 class="text-lg font-bold text-gray-800 dark:text-gray-100">Edit Buku</h1>
                    ...
                    <form method="POST" action="{{ route('buku.update', $buku->id) }}" class="mt-6 space-y-4"
